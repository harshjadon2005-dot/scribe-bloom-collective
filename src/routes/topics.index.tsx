  ...
  head: () => ({
    meta: [
      { title: "Knowledge Explorer — Lordiphosa" },
      {
        name: "description",
        content:
          "Explore the Lordiphosa knowledge library. Discover technologies, industries and ideas shaping tomorrow.",
      },
...
const faqs = [
  {
    ...
    answer:
      "Our editorial team updates the knowledge base daily. Trending topics and breaking developments are updated in real-time as new articles are published.",
  },
  {
    question: "How do you select featured topics?",
    answer:
      "Featured topics are chosen based on a combination of reader interest, industry momentum, and the volume of groundbreaking research or news in that sector.",
  },
  {
    question: "Can I follow specific topics?",
    answer:
      "Yes, you can subscribe to our newsletter and select your preferred topics to receive curated weekly digests tailored to your interests.",
  },
  {
    question: "Who writes the articles in these collections?",
    answer:
      "Our articles are written by a mix of our dedicated editorial team, industry experts, researchers, and contributing engineers who are actively working in these fields.",
  },
];
    ...
    <SiteLayout>
      ...
      <Container size="wide" className="pt-20 pb-24">
        <div className="text-center max-w-4xl mx-auto">
          <div className="eyebrow mb-6 uppercase tracking-[0.2em] text-[10px] font-semibold text-accent">
            Knowledge Explorer
          </div>
      ...
      <div className="bg-secondary/40 border-y border-border overflow-hidden">
        <Container
          size="wide"
          className="py-8 flex flex-col md:flex-row items-center md:items-start gap-6"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {popularCollections.map((c) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="text-[9px] uppercase tracking-widest text-ink-soft mb-2">
                ...
                {style === "horizontal" ? (
                  <div className="flex flex-col md:flex-row h-full">
                    ...
                    <div className="order-2 md:order-1 w-full md:w-[55%] p-6 lg:p-8 flex flex-col justify-between">
                      <div>
                        <h3 className="font-display text-3xl group-hover:text-accent transition-colors tracking-tight mb-3">
                          {topic.name}
                        </h3>
                          ...
                          <div className="mb-6 pt-5 border-t border-border/50">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className="text-[9px] uppercase tracking-widest text-accent font-semibold">
                                {latestArticle.readingMinutes} min read
                              </span>
                            </div>
              ...
              <div className="flex flex-col gap-6">
                {[
                  ...
                  <Link
                    ...
                    className="group flex items-start justify-between border-b border-border/50 pb-6 last:border-0 last:pb-0"
                  >
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {editorCollections.map((c) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="font-display text-2xl mb-1 group-hover:text-accent transition-colors">
                    {c.name}
                  </h3>
                  <div className="text-[10px] uppercase tracking-widest text-ink-soft">
                    {c.articleCount} Articles
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-ink-soft">
              Everything you need to know about our knowledge explorer.
            </p>
          </div>
            ...
            {faqs.map((faq, index) => (
              <details key={index} className="group py-6">
                <summary className="font-display text-2xl cursor-pointer list-none flex items-center justify-between group-hover:text-accent transition-colors">
                  {faq.question}
                  <span className="text-accent text-3xl font-light group-open:rotate-45 transition-transform duration-300">
                    +
                  </span>
                </summary>
