  ...
  notFoundComponent: () => (
    <SiteLayout>
      <Container className="py-32 text-center">
        ...
        <Link to="/topics" className="mt-6 inline-block border-b border-accent pb-1">Browse all topics</Link>
      </Container>
    </SiteLayout>
  ),
});
          ...
          <Container size="wide" className="pb-24">
            <div className="grid lg:grid-cols-12 gap-14">
              ...
              <aside className="lg:col-span-4">
                <div className="eyebrow mb-4" style={{ color: "var(--ink-soft)" }}>Popular in {topic.name}</div>
