        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-ink-soft leading-relaxed max-w-xl mb-12">
              Independent journalists, engineers, researchers, analysts, and industry experts
              helping readers understand technology, AI, software engineering, cybersecurity,
              startups, and the future of innovation.
            </p>
        ...
        <Container size="wide" className="py-24">
          ...
          <div className="grid md:grid-cols-12 gap-12 items-center bg-background border border-border p-8 md:p-16 hover:shadow-lg transition-shadow duration-500">
            <div className="md:col-span-4">
              <div className="aspect-[3/4] overflow-hidden border border-border">
                {featuredEditor.portrait ? (
                  <img
                    src={featuredEditor.portrait}
                    alt={featuredEditor.name}
            ...
            <div className="md:col-span-8 flex flex-col justify-center">
              <div className="text-[10px] uppercase tracking-widest text-ink-soft mb-3">
                {featuredEditor.role}
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {featuredEditor.expertise.map((e: string) => (
                  <span
                    key={e}
                    className="text-[10px] font-semibold uppercase tracking-widest px-3 py-1 bg-secondary/50 border border-border text-ink-soft"
                  >
                    {e}
                  </span>
                ))}
                ...
                {(() => {
                  ...
                  return latestArticle ? (
                    <div className="hidden sm:block">
                      <div className="text-[10px] uppercase tracking-widest text-ink-soft mb-1">
                        Latest Article
                      </div>
                      <Link
                        to="/articles/$slug"
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="font-display text-3xl group-hover:text-accent transition-colors mb-1">
                          {author.name}
                        </h3>
                        <div className="text-[10px] uppercase tracking-widest text-ink-soft">
                          {author.role}
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {author.expertise.slice(0, 2).map((e: string) => (
                        <span
                          key={e}
                          className="text-[10px] uppercase tracking-widest px-2 py-1 bg-secondary/50 border border-border text-ink-soft"
                        >
                          {e}
                        </span>
                      ))}
      ...
      <div className="py-24 mt-12 border-t border-border">
        <Container size="wide">
          <div className="mb-12 border-b border-border pb-6 flex justify-between items-end">
            ...
            <Link
              to="/articles"
              className="hidden sm:flex items-center text-sm font-medium hover:text-accent transition-colors"
            >
              ...
              return (
                ...
                >
                      ...
                      <div className="flex items-center gap-3">
                        {author.portrait ? (
                          <img
                            src={author.portrait}
                            alt={author.name}
                            className="w-8 h-8 rounded-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all border border-border"
                          />
                        ) : (
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-ink-soft line-clamp-2 max-w-3xl">{article.excerpt}</p>
                  </div>
